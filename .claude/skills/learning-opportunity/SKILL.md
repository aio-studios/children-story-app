...
description: Pause implementation work to teach a concept from the current codebase at three increasing levels of depth, tailored to a technical PM's skill level. Use when the user wants to understand something we just built rather than keep shipping.
---
